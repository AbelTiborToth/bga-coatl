...
require_once("../../modules/php/Prophecies/ProphecyScorer/BlackX_OLD.class.php");
...
/**
 * BlackXTest:
 * BlackXTest class is responsible for testing the functionality of the BlackX class.
 * It validates the scoring mechanism for the game elements based on specific test cases.
 */
class BlackXTest extends TestCase
{
	/**
	 * test_BlackX:
	 * Tests the scoring and level calculation for the BlackX class based on input parameters.
	 ...
	 * @return void
	 */
	#[DataProvider('provider_BlackX')]
	public function test_BlackX(PieceColor $piece_color, Cooatl $coatl, int $score, int $level)
	{
		$scorer = new BlackX($piece_color);
	...
	/**
	 * provider_BlackX:
	 * Provides test data combinations for the `provider_BlackX` method.
	 * @return array
	 */
	public static function provider_BlackX(): array
	{
		$data = array();
