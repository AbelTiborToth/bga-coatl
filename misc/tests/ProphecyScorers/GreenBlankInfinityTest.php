...
require_once("../../modules/php/Prophecies/ProphecyScorer/GreenBlankInfinity.class.php");
...
/**
 * GreenBlankInfinityTest:
 * GreenBlankInfinityTest class is responsible for testing the functionality of the GreenBlankInfinity class.
 * It validates the scoring mechanism for the game elements based on specific test cases.
 */
class GreenBlankInfinityTest extends TestCase
{
	/**
	 * test_GreenBlankInfinity:
	 * Tests the scoring and level calculation for the GreenBlankInfinity class based on input parameters.
	 ...
	 * @return void
	 */
	#[DataProvider('provider_GreenBlankInfinity')]
	public function test_GreenBlankInfinity(PieceColor $piece_color_1, PieceColor $piece_color_2, Cooatl $coatl, int $score, int $level)
	{
		$scorer = new GreenBlankInfinity($piece_color_1, $piece_color_2);
	...
	/**
	 * provider_GreenBlankInfinity:
	 * Provides test data combinations for the `provider_GreenBlankInfinity` method.
	 * @return array
	 */
	public static function provider_GreenBlankInfinity(): array
	{
		$data = array();
		foreach ([
						[
