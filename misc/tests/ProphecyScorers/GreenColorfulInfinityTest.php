...
require_once("../../modules/php/Prophecies/ProphecyScorer/GreenColorfulInfinity.class.php");
...
/**
 * GreenColorfulInfinityTest:
 * GreenColorfulInfinityTest class is responsible for testing the functionality of the GreenColorfulInfinity class.
 * It validates the scoring mechanism for the game elements based on specific test cases.
 */
class GreenColorfulInfinityTest extends TestCase
{
	/**
	 * GreenColorfulInfinity_1:
	 * Tests the scoring and level calculation for the GreenColorfulInfinity class based on input parameters.
	 * @param PieceColor $piece_color_1 The color of the first piece used for scoring.
	 * @param PieceColor $piece_color_8 The color of the infinity piece used for scoring.
	 ...
	 * @return void
	 */
	#[DataProvider('provider_GreenColorfulInfinity_1')]
	public function test_GreenColorfulInfinity_1(PieceColor $piece_color_1, PieceColor $piece_color_8, PieceColor $piece_color_2, Cooatl $coatl, int $score, int $level)
	{
		$scorer = new GreenColorfulInfinity($piece_color_1, $piece_color_8, $piece_color_2);
	...
	/**
	 * provider_GreenColorfulInfinity_1:
	 * Provides test data combinations for the `provider_GreenColorfulInfinity_1` method.
	 * @return array
	 */
	public static function provider_GreenColorfulInfinity_1(): array
	{
		$data = array();
		foreach ([
						[
			...
			$data[] = [
				...
				new Cooatl(0, 0, [
					...
					new Piece(9, PieceType::Body, $piece_colors[0]),
				], [], null, false),
				0,
				0
			];
			$data[] = [
				...
				new Cooatl(0, 0, [
					...
					new Piece(9, PieceType::Body, $piece_colors[1]),
				], [], null, false),
				0,
				0
			];
			$data[] = [
				...
				new Cooatl(0, 0, [
					...
					new Piece(9, PieceType::Body, $piece_colors[2]),
				], [], null, false),
				0,
				0
			];
	...
	/**
	 * GreenColorfulInfinity_2:
	 * Tests the scoring and level calculation for the GreenColorfulInfinity class based on input parameters.
	 * @param PieceColor $piece_color_1 The color of the first piece used for scoring.
	 * @param PieceColor $piece_color_8 The color of the infinity piece used for scoring.
	 * The second color is same as the first one
	 * @param Cooatl $coatl The Cooatl object that the scoring is applied to.
	 * @param int $score The expected score for the given parameters.
	 * @param int $level The expected level for the given parameters.
	 * @return void
	 */
	#[DataProvider('provider_GreenColorfulInfinity_2')]
	public function test_GreenColorfulInfinity_2(PieceColor $piece_color_1, PieceColor $piece_color_8, Cooatl $coatl, int $score, int $level)
	{
		$scorer = new GreenColorfulInfinity($piece_color_1, $piece_color_8);
		$result = $scorer->score($coatl);
		$this->assertEquals($score, $result["score"]);
		$this->assertEquals($level, $result["level"]);
	}
	...
	/**
	 * provider_GreenColorfulInfinity_2:
	 * Provides test data combinations for the `provider_GreenColorfulInfinity_2` method.
	 * @return array
	 */
	public static function provider_GreenColorfulInfinity_2(): array
	{
		$data = array();
		foreach ([
						[
