...
<script type="text/javascript">
	...
	const jstpl_first_player_token = '<div>' +
		'<p><span id=counter_${player_id}_prophecy></span></p><p>/5</p><prophecy_icon id=${player_id}_prophecy_icon class=prophecy_icon display="block"></prophecy_icon>' +
		...
		'</div>' +
		'<div>' +
		'<p><span id=counter_${player_id}_board></span></p><p>/8</p><board_icon id=${player_id}_board_icon class=board_icon display="block"></board_icon>' +
		'<p><span id=counter_${player_id}_coatl></span></p><p>/3</p><coatl_icon id=${player_id}_coatl_icon class=coatl_icon></coatl_icon>' +
		'</div>';
	...
	const jstpl_coatl_container =
		...
		'<div id="${id}_container" class="coatl_container" active="false">' +
