...
trait Actions
{
	...
	function actAddProphecy(Cooatl $coatl, Prophecy $prophecy): void
	{
		...
		if ($score === 0 || $coatl->is_locked || count($coatl->prophecies) === 4 || $coatl->hasDuplicateProphecy($prophecy)) throw new BgaVisibleSystemException("Actions.actAddProphecy: This action isn't possible now");
