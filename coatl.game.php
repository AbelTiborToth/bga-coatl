...
class coatl extends Table
{
	...
	protected function getAllDatas(): array
	{
		...
		foreach ($players as $player_id => $player) {
			...
			$result['players'][$player_id]["board_count"] = $this->countPiecesOnPlayerBoard($player_id, true);
			$result['players'][$player_id]["coatl_count"] = $this->countFinishedCoatls($this->getCoatlsOfPlayer($player_id));
